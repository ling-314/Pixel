...
{
	DWORD dwNewLong;
	if (fixedSize) dwNewLong = parent ? WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU | WS_MINIMIZEBOX | WS_CHILD : WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU | WS_MINIMIZEBOX;
	else dwNewLong = parent ? WS_OVERLAPPEDWINDOW | WS_CHILD : WS_OVERLAPPEDWINDOW;
	SetWindowLongPtr(hWnd, GWL_STYLE, dwNewLong);
}
