...
void Pixel::Renderer::RenderEllipse(Point position, float scale, int radiusX, int radiusY, Color color, bool fill, float strokeWidth)
{
	SetColor(color);
	if (fill)
...
void Pixel::Renderer::RenderRectangle(Point position, float scale, int width, int height, Color color, bool fill, float strokeWidth)
{
	SetColor(color);
	if (fill)
...
void Pixel::Renderer::RenderLine(Point vertex1, Point vertex2, Color color, float strokeWidth)
{
	SetColor(color);
